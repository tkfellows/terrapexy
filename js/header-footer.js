...
function getNavbarHeader() {
    ...
    const navBarMainLogoAttributes = {
        ...
        href: "http://terrapexy.com/index.html"
    };
    ...
    <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="http://terrapexy.com/about-me.html">About me</a></li>
            <li><a class="dropdown-item" href="http://terrapexy.com/documents/Fellows_CV.pdf" download="Fellows_CV.pdf">CV</a></li>
        </ul>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="http://terrapexy.com/research.html">Research</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="http://terrapexy.com/publications.html">Publications</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="http://terrapexy.com/media.html">Media</a>
    </li>
    <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Hobbies
        ...
        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="http://terrapexy.com/hobbies/coding-projects.html">Coding</a></li>
            <li><a class="dropdown-item" href="http://terrapexy.com/hobbies/climbing.html">Climbing</a></li>
            <li><a class="dropdown-item" href="http://terrapexy.com/hobbies/photography.html">Photography</a></li>
        </ul>
    </li>
    `;
...
function getNavbarFooter() {
    ...
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
        ...
        <a href="/" class="mb-3 me-2 mb-md-0 text-muted text-decoration-none lh-1">
            <svg class="bi" width="30" height="24"><use xlink:href="http://terrapexy.com/aboue-me.html"></use></svg>
        </a>
        <span class="mb-3 mb-md-0 text-muted">Created by Tyee Fellows © 2024 </span>
        </div>
        ...
        <li class="ms-3">
            <a href="mailto:tyeekfellows@gmail.com" class="text-muted">
